...
<body>
  <div id="content">
    <div class="modal">
      <form action="../merci.php?cat=payment" method="POST" class="form">
      ...
      <div class="separator">
        <hr class="line">
        <p>Ou paiement par carte</p>
        <hr class="line">
      </div>
      <div class="credit-card-info--form">
        <div class="input_container">
          <label for="password_field" class="input_label">Nom complet</label>
          <input id="password_field" class="input_field" type="text" name="input-name" title="Inpit title" placeholder="Enter your full name" requred>
        </div>
        <div class="input_container">
          <label for="password_field" class="input_label">Numéro de carte</label>
